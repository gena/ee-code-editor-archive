...
var time0 = [ee.Date.fromYMD(2000, 1, 1), 24]; // [ee.Date.fromYMD(2000, 1, 1), 24];
var time1 = [ee.Date.fromYMD(2015, 1, 1), 24]; //[ee.Date.fromYMD(2015, 1, 1), 24];
...
throw('stop') // comment this to add export of TIFs
