...
var pt1 = /* color: d63000 */ee.Geometry.Point([-118.86099815368652, 34.46693854910796]),
    geometry = /* color: 0B4A8B */ee.Geometry.Polygon(
        [[[-118.70075225830078, 34.53003559175403],
          [-118.86589050292969, 34.530742686986606],
          [-118.86709213256836, 34.45986191328104],
          [-118.70349884033203, 34.45844651413059]]]);
...
Export.video.toDrive({
    ...
    description: 'surface-water-changes-Lake-Piru',
    dimensions: 1920,
    region: bounds,
    framesPerSecond: 2,
    crs: 'EPSG: 4326',
