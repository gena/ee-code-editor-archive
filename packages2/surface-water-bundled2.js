          [43.78326416015625, 32.98217212792488],
          [43.6322021484375, 33.16629497884489],
          [43.468780517578125, 33.15709799197017],
          [43.33282470703125, 32.98562797456918],
          [43.33282470703125, 32.7999732056984],
          [43.477020263671875, 32.57111987302095]]]),
    aoiBuendia = /* color: #ffc82d */ee.Geometry.Polygon(
        [[[-2.7513885498046875, 40.3549167507906],
          [-2.7386856079101562, 40.34445080136368],
          [-2.724609375, 40.33345980653098],
          [-2.7084732055664062, 40.31670818109447],
          [-2.6978302001953125, 40.31880236161984],
          [-2.6858139038085938, 40.33241295173677],
          [-2.673797607421875, 40.347590756726525],
          [-2.6978302001953125, 40.37087419654953],
          [-2.7016067504882812, 40.384212768155045],
          [-2.7016067504882812, 40.40408495539547],
          [-2.6789474487304688, 40.416894177003456],
          [-2.6370620727539062, 40.430746304509185],
          [-2.5927734375, 40.4297009604458],
          [-2.5591278076171875, 40.443027880081786],
          [-2.5759506225585938, 40.457397087754444],
          [-2.6123428344726562, 40.45765831763663],
          [-2.6556015014648438, 40.45844200118894],
          [-2.6741409301757812, 40.45922567559978],
          [-2.6810073852539062, 40.45400100685691],
          [-2.71087646484375, 40.442505305546845],
          [-2.7318191528320312, 40.44381173426701],
          [-2.747955322265625, 40.44093755756703],
          [-2.7630615234375, 40.42473535424809],
          [-2.79052734375, 40.40251631173469],
          [-2.7884674072265625, 40.38891986882412],
          [-2.7719879150390625, 40.36459630797086],
          [-2.7592849731445312, 40.360933936261134],
          [-2.7510452270507812, 40.397287235530705]]]),
    aoiRengali = /* color: #d63000 */ee.Geometry.Polygon(
        [[[84.94422912597656, 21.2912937068574],
          [85.00877380371094, 21.265700300746985],
          [85.05271911621094, 21.262500811992567],
          [85.10765075683594, 21.252261980810392],
          [85.15159606933594, 21.272099069646202],
          [85.16326904296875, 21.30920644097061],
          [85.13923645019531, 21.38595054382069],
          [85.14404296875, 21.444121337131314],
          [85.12687683105469, 21.44348222355954],
          [85.07881164550781, 21.465210513697368],
          [85.05546569824219, 21.48374090716327],
          [85.03280639648438, 21.48118513100344],
          [85.03555297851562, 21.530375936130728],
          [85.02388000488281, 21.587850568754245],
          [84.98268127441406, 21.58401963548716],
          [84.96002197265625, 21.562309099955996],
          [84.92912292480469, 21.51185148258817],
          [84.8748779296875, 21.494602455215073],
          [84.83299255371094, 21.4620153800228],
          [84.82269287109375, 21.442203988015734],
          [84.83573913574219, 21.41407997342895],
          [84.86320495605469, 21.385311175714424],
          [84.88380432128906, 21.380196130286645],
          [84.90577697753906, 21.375080906078395],
          [84.90234375, 21.360373640929254],
          [84.89547729492188, 21.346304440359805],
          [84.91539001464844, 21.32263955826531]]]),
    geometry = /* color: #d63000 */ee.Geometry.Point([-122.41344451904297, 40.737892702684064]);
...
// var occurrence = ee.Image('users/gena/eo-bathymetry/NDWI/NDWI-4764-v9-Dam-Al-Massira')
// aoi = aoiAlMassira

//var occurrence = ee.Image('users/gena/eo-bathymetry/NDWI/NDWI-4764-v9-IndiraSagar')
// var aoi = aoiIndiraSagar

// var occurrence = ee.Image('users/gena/eo-bathymetry/NDWI/NDWI-4764-v9-Dam-Mosul')
// var aoi = aoiMosul

//var occurrence = ee.Image('users/gena/eo-bathymetry/NDWI/NDWI-4764-v9-Razazza')
//var aoi = aoiRazazza

//var occurrence = ee.Image('users/gena/eo-bathymetry/NDWI/NDWI-4764-v9-Buendia')
//var aoi = aoiBuendia

// var occurrence = ee.Image('users/gena/eo-reservoirs/composite-4764-Rentgali').select('MNDWI')
// var aoi = aoiRengali

// occurrence = occurrence.unitScale(-0.05, 0.33).mask(occurrence.gt(-0.05))


// use JRC water occurrence
var occurrence = ee.Image('JRC/GSW1_0/GlobalSurfaceWater').select('occurrence').divide(100)
//aoi = ee.Geometry(Map.getBounds(true)).bounds()

var waterMax = occurrence.gt(0.05)

var waterMaxVector = waterMax.reduceToVectors({
  geometry: Map.getBounds(true),
  scale: scale 
})

var aoi = waterMaxVector.filterBounds(geometry).geometry()
  .buffer(150)


occurrence = occurrence.unmask().resample('bilinear')
...
function fillMissingWater(i, snowMask, cloudMask, imageMask, edges, pmin, pmax) {
  ...
  var occurrenceExpected = occurrence.mask(edge).reduceRegion({reducer:expectedWaterReducer, geometry: aoi, scale: scale, maxPixels: 1e13}
    ).values().get(0)
...
*/      
  ...
  var occurrenceUpdatedMax = ee.Number(occurrenceUpdated.reduceRegion({
    reducer: ee.Reducer.max(), geometry: aoi, scale: scale, maxPixels: 1e13}).values().get(0));
  ...
  var filled = occurrence.unmask(0, false).gte(occurrenceExpected) // probability is greater than expected
    .multiply(
        occurrenceUpdatedRange.not() // no fill-in within confusion zone
          .or(cloudMask.unmask(0, false)) // except if there are clouds
          .or(imageMask.unmask(0, false).not()) // except if image is missing
    )
    /*
    .multiply(
        occurrenceUpdatedRange.not() // no fill-in within confusion zone
...
*/
  ...
  var originalArea = ee.Image.pixelArea().mask(i)
    .reduceRegion({ reducer: ee.Reducer.sum(), geometry: aoi, scale: scale, maxPixels: 1e13 }).values().get(0);
...
var app = function app() {
    ...
    var translateParams = {x: 30000, y: 0, units: 'meters', proj: 'EPSG:3857'}
    ...
    function processImages(collection) {
        ...
        images = images.map(function (image) {
            var value = ee.Dictionary(image.select(collection.visual.bands[0]).reduceRegion(
                { reducer: ee.Reducer.firstNonNull(), geometry: aoi, scale: 100, maxPixels: 1e13 }
                )).values().get(0);
...
function computeThresholdUsingOtsu(image, scale, bounds, th, g, skipShort, weightGradient, minValue, useLowValues) {
    ...
    if(debug) {
      printChart(ui.Chart.image.histogram(edge.mask(edge.gt(0)), bounds, scale, buckets).setOptions({title:'edge values'}));
    }
    ...
    if(updateEdgesWithDensity && !useLowValues) {
      ...
      var occurrenceEdgePercentile = occurrenceEdge.reduceRegion({reducer: ee.Reducer.median(), geometry: bounds, scale: scale, maxPixels: 1e13} ).values().get(0)
      ...
      if(debug) {
        ...
        printChart(ui.Chart.image.histogram(occurrenceEdge, bounds, scale, buckets).setOptions({title:'density, edges'}));
...
*/          
          ...
          var percentile = 85
          var p = ee.Number(ee.Dictionary(edgeGradient.reduceRegion({reducer: ee.Reducer.percentile([percentile]), geometry: bounds, scale: scale, maxPixels: 1e13})).values().get(0));
          var significantEdgesMask = ee.Image(ee.Algorithms.If(
              ee.Algorithms.IsEqual(p, null),
              ee.Image(0),
              edgeGradient.gt(p)
          ...
          if (debug) {
              printChart(ui.Chart.image.histogram(edgeGradient, bounds, scale, _buckets));
          ...
          var p = ee.Number(ee.Dictionary(edgeValues.reduceRegion({reducer: ee.Reducer.percentile([percentile]), geometry: bounds, scale: scale, maxPixels: 1e13})).values().get(0));
          var significantEdgesMask = ee.Image(ee.Algorithms.If(
              ee.Algorithms.IsEqual(p, null),
              ee.Image(0),
    ...
    var buckets = 100;
    var hist = ee.Dictionary(ee.Dictionary(imageEdge.reduceRegion({reducer: ee.Reducer.histogram(buckets), geometry: bounds, scale: scale, maxPixels: 1e13})).values().get(0));
    ...
    if (debug) {
        ...
        printChart(ui.Chart.image.histogram(image, bounds, scale, buckets).setOptions({title:'image, bounds'}));
        printChart(ui.Chart.image.histogram(imageEdge, bounds, scale, buckets).setOptions({title:'image, edges'}));
...
Algorithms.filter = function (images, collection, geometry, options) {
    ...
    if (options.skipEmpty) {
        images = images.map(function (image) {
            var value = ee.Dictionary(image.select(collection.visual.bands[0]).reduceRegion(
                {reducer: ee.Reducer.firstNonNull(), geometry: geometry, scale: 100, maxPixels: 1e13})).values().get(0);
...
Algorithms.Aster.detectWater = function (image, info, returnImage) {
    ...
    var waterScore = reflectance.resample('bilinear').normalizedDifference(['green', 'nir']);
    ...
    if (returnImage) {
        return water.set('system:time_start', image.get('system:time_start')).set('nodata_pixels', ee.Dictionary(mask.not()
          .reduceRegion({reducer: ee.Reducer.sum(), geometry: analysisExtent, scale: scale, maxPixels: 1e13})).values().get(0)).set('cloud_pixels', ee.Dictionary(cloudMask.reduceRegion(ee.Reducer.sum(), analysisExtent, scale)).values().get(0))
        //.set('cloud_shadow_pixels', ee.Dictionary(cloudShadows.reduceRegion(ee.Reducer.sum(), analysisExtent, scale)).values().get(0))
        .set('snow_pixels', ee.Dictionary(snowMask.reduceRegion(
            {reducer: ee.Reducer.sum(), geometry: analysisExtent, scale: scale, maxPixels: 1e13})).values().get(0)).set('water_threshold', th);
    }
    ...
    return {
      waterMask: ee.FeatureCollection(waterVector.copyProperties(image)).set('system:time_start', image.get('system:time_start')).set('nodata_pixels', ee.Dictionary(mask.not()
        .reduceRegion({ reducer: ee.Reducer.sum(), geometry: analysisExtent, scale: scale, maxPixels: 1e13})).values().get(0)).set('cloud_pixels', ee.Dictionary(cloudMask.reduceRegion(ee.Reducer.sum(), analysisExtent, scale)).values().get(0)).set('cloud_shadow_pixels', ee.Dictionary(cloudShadows.reduceRegion(ee.Reducer.sum(), analysisExtent, scale)).values().get(0)).set('snow_pixels', ee.Dictionary(snowMask.reduceRegion(ee.Reducer.sum(), analysisExtent, scale)).values().get(0)).set('water_threshold', th),
      snowMask: snowMask,
      cloudMask: cloudMask,
...
Algorithms.Aster.getCloudPixelCount = function (image, info) {
    ...
    return ee.Dictionary(cloudMask.reduceRegion(
        { reducer: ee.Reducer.sum(), geometry: analysisExtent, scale: scale, maxPixels: 1e13})).values().get(0);
};
...
Algorithms.Aster.getSnowPixelCount = function (image, info) {
    ...
    return ee.Dictionary(snowMask.reduceRegion(
        {reducer: ee.Reducer.sum(), geometry: analysisExtent, scale: scale, maxPixels: 1e13})).values().get(0);
};
...
Algorithms.Aster.getNoDataPixelCount = function (image, info) {
    ...
    return ee.Dictionary(mask.not().reduceRegion({reducer: ee.Reducer.sum(), geometry: analysisExtent, scale: scale, maxPixels: 1e13})).values().get(0);
};
...
Algorithms.Aster.onLayerAdd = function (image, info) {
    ...
    //var waterScore = image.resample('bilinear').normalizedDifference(['green', 'nir']);
    ...
    var water = i.gte(ee.Image.constant(th));
    Map.addLayer(water.mask(water), {}, 'water mask', false);
...
Algorithms.AsterT.detectWater = function (image, info, returnImage) {
    image = image.clip(aoi).resample('bilinear');
    ...
    var mode = ee.Number(ee.Dictionary(t.reduceRegion(
        {reducer: ee.Reducer.mode(), geometry: waterPermanentCenter, scale: errorMargin * 5, maxPixels: 1e13})).get('temp'));
...
Algorithms.Landsat.onLayerAdd = function (image, info) {
    ...
    // MNDWI
    var mndwi = image.resample('bilinear').normalizedDifference(['green', 'swir']);
    //waterScore = rescale(waterScore, 'img', [-0.2, 0.35])
    //waterScore = waterScore.mask(waterScore)
    Map.addLayer(mndwi, { palette: Palettes.water }, 'water score (MNDWI)', false);

    // NDWI
    var ndwi = image.resample('bilinear').normalizedDifference(['green', 'nir']);
    //let waterScore = rescale(waterScore, 'img', [-0.2, 0.35])
    //waterScore = waterScore.mask(waterScore)
...
Algorithms.Landsat.detectWater = function (image, info, returnImage) {
    ...
    var waterScore = image.resample('bilinear').normalizedDifference(['green', 'nir']);
    //var waterScore = image.resample('bilinear').normalizedDifference(['green', 'swir'])
    ...
    if (returnImage) {
        return water.set('system:time_start', image.get('system:time_start')).set('nodata_pixels', ee.Dictionary(mask.not()
          .reduceRegion({reducer: ee.Reducer.sum(), geometry: analysisExtent, scale: scale, maxPixels: 1e13})).values().get(0)).set('cloud_pixels', ee.Dictionary(cloudMask.reduceRegion(ee.Reducer.sum(), analysisExtent, scale)).values().get(0))
        //.set('cloud_shadow_pixels', ee.Dictionary(cloudShadows.reduceRegion(ee.Reducer.sum(), analysisExtent, scale)).values().get(0))
        .set('snow_pixels', ee.Dictionary(snowMask
          .reduceRegion({reducer: ee.Reducer.sum(), geometry: analysisExtent, scale: scale, maxPixels: 1e13})).values().get(0)).set('water_threshold', th);
    }
    ...
    return {
      waterMask: ee.FeatureCollection(waterVector.copyProperties(image))
        .set('system:time_start', image.get('system:time_start'))
        .set('nodata_pixels', ee.Dictionary(mask.not().reduceRegion({reducer: ee.Reducer.sum(), geometry: analysisExtent, scale: scale, maxPixels: 1e13})).values().get(0))
        .set('cloud_pixels', ee.Dictionary(cloudMask.reduceRegion({reducer: ee.Reducer.sum(), geometry: analysisExtent, scale: scale, maxPixels: 1e13})).values().get(0))
        .set('cloud_shadow_pixels', ee.Dictionary(cloudShadows.reduceRegion({reducer: ee.Reducer.sum(), geometry: analysisExtent, scale: scale, maxPixels: 1e13})).values().get(0))
        .set('snow_pixels', ee.Dictionary(snowMask.reduceRegion({reducer: ee.Reducer.sum(), geometry: analysisExtent, scale: scale, maxPixels: 1e13})).values().get(0))
...
Algorithms.Landsat.getCloudPixelCount = function (image, info) {
    ...
    return ee.Dictionary(cloudMask.reduceRegion({reducer: ee.Reducer.sum(), geometry: analysisExtent, scale: scale, maxPixels: 1e13})).values().get(0);
};
...
Algorithms.Landsat.getSnowPixelCount = function (image, info) {
    ...
    return ee.Dictionary(snowMask.reduceRegion({reducer: ee.Reducer.sum(), geometry: analysisExtent, scale: scale, maxPixels: 1e13})).values().get(0);
};
...
Algorithms.Sentinel1.detectWater = function (image, info, returnImage) {
    ...
    return {
      waterMask: ee.FeatureCollection(waterVector.copyProperties(image)).set('system:time_start', 
        image.get('system:time_start')).set('nodata_pixels', ee.Dictionary(water.mask().not().reduceRegion({reducer: ee.Reducer.sum(), geometry: analysisExtent, scale: scale, maxPixels: 1e13})).values().get(0)).set('cloud_pixels', 0).set('cloud_shadow_pixels', 0).set('snow_pixels', 0).set('water_threshold', th),
      snowMask: ee.Image(),
      cloudMask: ee.Image(),
      imageMask: image.mask(),
      edges: results.edges
...
Algorithms.Sentinel2.detectWater = function (image, info, returnImage) {
    ...
    if (returnImage) {
        return water.set('system:time_start', image.get('system:time_start')).set('nodata_pixels', ee.Dictionary(mask.not().reduceRegion({reducer: ee.Reducer.sum(), geometry: analysisExtent, scale: scale, maxPixels: 1e13})).values().get(0)).set('cloud_pixels', ee.Dictionary(cloudMask
          .reduceRegion({reducer: ee.Reducer.sum(), geometry: analysisExtent, scale: scale, maxPixels: 1e13})).values().get(0))
        //.set('cloud_shadow_pixels', ee.Dictionary(cloudShadows.reduceRegion({reducer: ee.Reducer.sum(), geometry: analysisExtent, scale: scale, maxPixels: 1e13})).values().get(0))
        .set('snow_pixels', ee.Dictionary(cloudMask.reduceRegion({reducer: ee.Reducer.sum(), geometry: analysisExtent, scale: scale, maxPixels: 1e13})).values().get(0)).set('water_threshold', th);
    }

    var waterVector = water.mask(water).reduceToVectors({ geometry: analysisExtent, scale: errorMargin });
    waterVector = filterToIntersection(waterVector, analysisExtent);

    var waterMask = ee.FeatureCollection(waterVector.copyProperties(image)).set('system:time_start', image.get('system:time_start')).set('nodata_pixels', ee.Dictionary(mask.not().reduceRegion({reducer: ee.Reducer.sum(), geometry: analysisExtent, scale: scale, maxPixels: 1e13})).values().get(0)).set('cloud_pixels', ee.Dictionary(cloudMask.reduceRegion({reducer: ee.Reducer.sum(), geometry: analysisExtent, scale: scale, maxPixels: 1e13})).values().get(0))
    //.set('cloud_shadow_pixels', ee.Dictionary(cloudShadows.reduceRegion({reducer: ee.Reducer.sum(), geometry: analysisExtent, scale: scale, maxPixels: 1e13})).values().get(0))
    .set('snow_pixels', ee.Dictionary(cloudMask.reduceRegion({reducer: ee.Reducer.sum(), geometry: analysisExtent, scale: scale, maxPixels: 1e13})).values().get(0)).set('water_threshold', th);
