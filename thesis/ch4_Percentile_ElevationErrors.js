...
function addPercentilesAndFalseColor() {
  ...
  Map.addLayer(ee.Algorithms.Terrain(srtm).select('hillshade'), {min:255, max:100}, 'hillshade')
  ...
  Map.addLayer(gallery, {}, 'gallery (percentiles)')
