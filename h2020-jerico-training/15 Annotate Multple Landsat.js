...
/*
Export.video.toDrive({collection: annotations, region: JSON.stringify(bounds), dimensions: '1920x1080'})

var length = annotations.size().getInfo()
var list = annotations.toList(length, 0)
for(var i = 0; i < length; i++) {
  var image = ee.Image(list.get(i))
  Export.image.toDrive({image: image, description:i.toString(), crs:'EPSG:3857', fileNamePrefix: i.toString(), region: JSON.stringify(bounds), dimensions: '1920x1080'})
}
