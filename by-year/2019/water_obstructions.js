...
var images = assets.getImages(bounds, {missions: ['S2'], resample: true, filter: ee.Filter.date('2017-01-01', '2018-01-01')})
  .sort('system:time_start')
images = assets.getMostlyCleanImages(images, bounds)
var vis = {min: 0.03, max: 0.35}
animation.animate(images, {vis: vis})
Map.addLayer(images.reduce(ee.Reducer.percentile([75])), vis, '75%')
Map.addLayer(images.reduce(ee.Reducer.percentile([15])), vis, '15%')
