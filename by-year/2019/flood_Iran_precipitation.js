...
var geometry = /* color: #d63000 */ee.Geometry.MultiPoint(),
    geometry2 = /* color: #98ff00 */ee.Geometry.Point([48.107182157984994, 31.54059467884849]);
...
// by day
var days = ee.List.sequence(0, 30)
var frames = days.map(function(d) {
  var t1 = ee.Date(startDate).advance(d, 'day')
  var t2 = t1.advance(1, 'day')
  
  var frame = ee.ImageCollection(dataset.images.filterDate(t1, t2).select(dataset.var)).reduce(ee.Reducer.percentile([85])).set('system:time_start', t1.millis());
