...
function slicExampleLandsat8() {
  ...
  var compactness = 0.2 // TODO: compute this automatically. This parameters trades off color-similarity and proximity
  var scaleFactor = 3
...
var numberOfUnsupervisedClusters = 12
var palette = require('users/gena/packages:colorbrewer').Palettes.Paired[12]
...
// try on SLIC image
var theRepaintedImage = results.image.select(['v1','v2','v3'])
...
function afn_Kmeans_unsegmented(input, numberOfUnsupervisedClusters, name) {
  ...
  var defaultStudyArea = Map.getBounds(true)
  ...
  print("layer c", c)
  Map.addLayer(c, {min: 0, max: 11, palette: palette}, name)
