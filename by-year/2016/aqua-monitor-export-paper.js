...
var time0 = [ee.Date.fromYMD(1984, 1, 1), 140];
var time1 = [ee.Date.fromYMD(2015, 1, 1), 12];

// larger periods, more robust, slower, may contain less changes
...
Map.addLayer(renderLandsatMosaic(options, 0), {}, options.dateIntervals[0][0].format('YYYY-MM-dd').getInfo(), false);
Map.addLayer(renderLandsatMosaic(options, timeCount - 1), {}, options.dateIntervals[timeCount - 1][0].format('YYYY-MM-dd').getInfo(), false);
