...
var years = [2000,2013];//Specify years- can enter a list or use range() function
var compositingPeriod = 3;//Number of years to include in the composite
var startJulian = 190;//Start julian date- supports wrapping
var endJulian = 250;//End julian date
