...
var vis = {min:0, max:0.5};

Map.addLayer(rgb.median(), vis, 'median RGB');

Map.addLayer(sng.median(), vis, 'median SNG');

Map.addLayer(sng.reduce(ee.Reducer.percentile([15])), vis, '15% percentile SNG');
