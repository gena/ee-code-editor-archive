    ...
    function exportRendered() {
        ...
        function exportWithText() {
            ...
            function renderWithText(i) {
                ...
                permenentWaterEdge, textDate, textSensor]).mosaic().set('system:time_start', startTime).set('collection', collection).set('system:id', id);
