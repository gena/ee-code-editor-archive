...
var app = function app() {
    ...
    function addDate(i) {
        ...
        return ee.ImageCollection.fromImages([i.visualize({ forceRgbOutput: true }), textDate.visualize({ forceRgbOutput: true })]).mosaic();
    }
    ...
    ee.List.sequence(0, countMapLayers - 1).getInfo(function (indices) {
        indices.map(function (index) {
            ...
            var layer = ui.Map.Layer(addDate(image), {}, index.toString(), false);
        ...
        features.toList(5000).map(function (f) {
            ...
            chart.onClick(function (xValue, yValue, seriesName) {
                ...
                ee.String(ee.String(new Date(xValue).toUTCString()).cat(' ').cat(image.get('system:id'))).getInfo(function (str) {
                    ...
                    var layer = ui.Map.Layer(addDate(image), {}, 'chart');
