...
var aoi = /* color: #d63000 */ee.Geometry.LinearRing(
        [[101.90789222717285, 20.666115614290124],
         [101.88935279846191, 20.665954998738293],
         [101.8776798248291, 20.671737051603085],
         [101.87639236450195, 20.69060749754457],
         [101.88042640686035, 20.692534559966795],
         [101.89098358154297, 20.688519818962963],
         [101.90969467163086, 20.689403071099637],
         [101.91862106323242, 20.691811914427255],
         [101.92917823791504, 20.683541392576238],
         [101.93072319030762, 20.673744657359034],
         [101.92995071411133, 20.66804298766494],
         [101.90789222717285, 20.666115614290124]]),
    ...
    locationFrameArea = /* color: #d63000 */ee.Geometry.LineString(
        [[101.8787956237793, 20.691330148821677],
         [101.93063735961914, 20.66571407509213]]),
    locationScalebar = /* color: #98ff00 */ee.Geometry.LineString(
        [[101.91535949393915, 20.66748083949589],
         [101.92222595990847, 20.66748083949589]]),
    jrc = ee.Image("JRC/GSW1_0/GlobalSurfaceWater");
/***** End of imports. If edited, may not auto-convert in the playground. *****/
occurrence = ee.Image("users/gena/water-occurrence-Laos-2007-2018")
...
var occurrenceMask = occurrence.mask().gt(0).focal_min(35, 'circle', 'meters').focal_max(35, 'circle', 'meters')
occurrence = occurrence.resample('bicubic').divide(100).mask(occurrenceMask)

// use current map as AOI
...
*/
    ...
    var clipEdges = true
    var minValue = -20
    var results = computeThresholdUsingOtsu(image, scale, aoi, 0.95, 3, clipEdges, true, minValue, true);
    var th = results.threshold;
