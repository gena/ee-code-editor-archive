...
var l8 = ee.ImageCollection("LANDSAT/LC8_L1T_TOA"),
    l7 = ee.ImageCollection("LANDSAT/LT5_L1T_8DAY_TOA"),
    water = ee.Image("MODIS/MOD44W/MOD44W_005_2000_02_24");
/***** End of imports. If edited, may not auto-convert in the playground. *****/
print(Map.getCenter())
//Map.setCenter(105.53, 12.09, 10)

// Earth engine script to extract water bodies from landsat 8. 
// Instead of obtaining the water threshold from the histogram around the water 
// edges this version uses a fixed threshold
// For internal use in SERVIR only. A final version will be released to the public (GPL-3)
// (c) Deltares 2015 

var azimuth = 90;
var zenith = 30;

// Adjust these to alter the detection settings
...
var images = l8.filterBounds(bounds).select(LC8_BANDS, STD_NAMES).filterDate(startdate, enddate);
//var images = l7.filterBounds(bounds).select(LC8_BANDS, STD_NAMES).filterDate(startdate, enddate);
var imagesAll = l8.filterBounds(bounds).select(LC8_BANDS, STD_NAMES)
...
function addPercentileLayers(images, percentile, water_color, water_edge_color, visible) {
...
addPercentileLayers(images, 8, '0000ff', 'ffffff', true)
addPercentileLayers(images, 40, '0000aa', 'aaaaaa', false)
addPercentileLayers(imagesAll, 40, '0000aa', 'aaaaaa', true)
