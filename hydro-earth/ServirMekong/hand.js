...
Map.addLayer(globcover.select('landcover').randomVisualizer(), {}, 'GlobCover', false)
...
Map.addLayer(hand_water.mask(hand_water).clip(aoi), {palette:['0000ff']}, 'HAND < 5m', false)
...
Map.addLayer(img, {min:0.05, max:0.4}, 'l8', false)

var ndvi = img.normalizedDifference(['B5', 'B4']);
Map.addLayer(ndvi, {palette: '000000, 0000aa, 00aa00', min:-1, max:1}, 'ndvi', false)

var mndwi = img.normalizedDifference(['B3','B6'])
Map.addLayer(mndwi, {min:-0.6, max:0.6}, 'mndwi', false)