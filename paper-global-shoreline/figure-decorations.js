    ...
    if(showLabels) {
      ...
      for(var i=0; i<this.steps+1; i++) {
        ...
        var imageLabel = Text.draw(markerText, ee.Geometry.Point(point), this.scale, {
          fontSize:16, textColor: '000000', outlineColor: 'ffffff', outlineWidth: 2})
...
Frame.prototype.draw = function() {
  ...
  var ul = ee.List(coords.get(3))
    ...
    var margins = ee.List([
      ...
      this.getMargin('horizontal', ul, ur, 15, -18, false), // top
      this.getMargin('vertical', translate(ll, this.marginSize, 0), translate(ul, this.marginSize, 0), 45, -5, true), // left
...
var Scalebar = {
  draw: function (pos, props) {
    ...
    var imageUnits = Text.draw(units, ee.Geometry.Point(point), scale, {
      fontSize:14, textColor: '000000', outlineColor: 'ffffff', outlineWidth: 2.5, outlineOpacity: 0.6})
